<%-- 
    Document   : DeleteHallInventory
    Created on : Jan 31, 2022, 4:44:31 PM
    Author     : End-User
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="../DeleteInventoryHall" method="POST">           
                ...
                <div class="col-sm-10">
                <input type="number" class="form-control" id="inputQuantity" name="quantity" value="<%= rs_hallItems.getInt("quantity") %>" disabled>
              </div>
                </div>
                <br><br>
                <div class="col-12">
